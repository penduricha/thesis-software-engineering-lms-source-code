...
export default class ExamDao {
    ...
    static async getExam_By_ExamID(examID, courseID) {
        let exam = null;
        await ExamService.fetchExam_By_ExamID(examID).then(response => {
            exam = response.data;
        }).catch(error => {
            console.error(error);
        })
    ...
    static async getExams_By_LecturerID_Lecturer_Calendar(lecturerID, yearStartDate, monthStartDate, dateStartDate) {
        let exams = [];
        await ExamService.fetchExams_By_LecturerID_Lecturer_Calendar
        (lecturerID,
            yearStartDate,
            monthStartDate,
