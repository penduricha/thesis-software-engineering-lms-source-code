...
export default class ExamService {
    ...
    static fetchExam_By_ExamID(examID) {
        return axiosConfig.getAPIClient().get(`/get_exam_by_exam_id/${examID}`);
    }
    ...
    static fetchExams_By_LecturerID_Lecturer_Calendar(lecturerID, yearStartDate, monthStartDate, dateStartDate) {
        return axiosConfig
            .getAPIClient()
            .get(`/view_exam_by_calendar_lecturer/${lecturerID}/${yearStartDate}/${monthStartDate}/${dateStartDate}`);
    }
