...
INSERT INTO project_thesis_final.bank_question_java_core (question_java_core_id, code_run_to_output, code_sample, content_question) VALUES (30, 'public static void main(String[] args) {
}', 'public static int getMaxElementInArray(int[] a) {
}', 'Tìm số lớn nhất trong mảng số nguyên (int).');
INSERT INTO project_thesis_final.bank_question_java_core (question_java_core_id, code_run_to_output, code_sample, content_question) VALUES (31, 'public static void main(String[] args) {
    int[] arr1 = { 64, 34, 25, 12, 22, 11, 90 };
	System.out.println(getMaxElementInArray(arr));
}', 'public static int getMaxElementInArray(int[] a) {
}', 'Viết hàm tìm số lớn nhất trong mảng các số nguyên. (int)');
