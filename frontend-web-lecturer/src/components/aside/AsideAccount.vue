...
export default {
  ...
  methods: {
    handleLogout() {
      ...
      lecturerLocalStorage.removeLecturerID_From_LocalStorage();
    ...
    async setAccount() {
      ...
      let lecturer = await LecturerDao.getLecturerName_And_LecturerID(lecturerID);
      console.log(lecturer);
      this.lecturerID = '0' + lecturer.lecturerID;
      ...
      if(this.lecturerID) {
        ...
        getExams_By_LecturerID_Lecturer_Calendar(this.lecturerID, yearStartDate, monthStartDate, dateStartDate);
    ...
    async validateCurrentPassword() {
      ...
      let lecturerPasswordHashed = await LecturerDao.getLecturerPasswordBy_LecturerID(lecturerID);
      if (lecturerPasswordHashed !== passwordHashed) {
        ...
        try {
          ...
          let statusUpdate = await LecturerDao.update_Password_By_LecturerID(lecturerID, passwordNewHashed);
