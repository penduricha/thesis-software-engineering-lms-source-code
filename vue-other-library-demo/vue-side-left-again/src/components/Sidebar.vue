  ...
  <aside :class="`${is_expanded ? 'is-expanded' : ''}`">
    ...
    <div class="menu-toggle-wrap">
      <button class="menu-toggle" @click="toggleMenu">
        ...
        <svg style="color: white; width: 30px; height: 30px"
    ...
    <div class="menu">
      ...
      <router-link to="/team" class="button">
          ...
          <svg
              style="width: 25px; height: 25px;"
              xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
